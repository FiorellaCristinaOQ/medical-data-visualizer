...
# Weight is in kg, but height is in cm
...
def draw_heat_map():
  ...
  sns.heatmap(corr, linewidths=1, annot=True, fmt='.1f', mask=mask, square=True, center=0, vmin=-0.1,vmax=0.25, cbar_kws={'shrink': .45,'format': '%.2f'})
  # vmin and vmax are for the colors to match the original picture
